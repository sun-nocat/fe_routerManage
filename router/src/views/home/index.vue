      ...
      <Header>
        <Menu mode="horizontal" theme="dark">
          ...
          <div class="layout-logo">
            <img
              @click="logo_click"
              src="../../assets/xy_logo.png"
              alt
              style="margin-left:-56px;height:40px;width:184px;"
            />
          </div>
          <div class="layout-nav">
            ...
            <MenuItem name="2">
              <a href="http://ipmanage.xupt.org/excel/export" style="color:#ddd;">
                <Icon type="ios-cloud-download-outline"></Icon>下载
              </a>
            </MenuItem>
            <MenuItem name="4">
              <div @click="logout">
                <Icon type="ios-cloud-download-outline"></Icon>退出登录
              </div>
            </MenuItem>
          </div>
        </Menu>
      ...
      <Layout>
        ...
        <Sider hide-trigger :style="{background: '#fff'}">
          ...
          >
            <Submenu name="1">
              <template slot="title">
                <Icon type="ios-navigate"></Icon>查看状态
              </template>
            ...
            <Submenu name="2">
              <template slot="title">
                <Icon type="ios-keypad"></Icon>分配ip
              </template>
            ...
            <Submenu name="3">
              <template slot="title">
                <Icon type="ios-analytics"></Icon>统计分析
              </template>
            ...
            <Submenu name="4">
              ...
              <MenuItem name="4-1">用户管理</MenuItem>
              <MenuItem name="4-2">邮件通知管理</MenuItem>
              <!-- <MenuItem name="4-3">添加用户</MenuItem> -->
            </Submenu>
          </Menu>
        </Sider>
  ...
  methods: {
    ...
    showSteps: function() {
      if (this.a == 0) {
        ...
        this.a = 1;
        return 0;
      } else if (this.a == 1) (this.step = false), (this.fist_list = true);
      this.a = 0;
    },
    select: function(msg) {
      //用户点击左侧的选项栏的唯一标识
